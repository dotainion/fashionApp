...
export const AddToCartButton = ({hidden, product, size, image, cssClass, onAdd, noBorder}) =>{
    return(
        <div hidden={hidden} className={`pad-xl ${cssClass}`} style={{border: noBorder || "1px solid lightgray",top:"50%",right:"50px"}}>
